...
const GALLERY_ITEM_HEIGHT = 480;

const CircularGallery = React.forwardRef<HTMLDivElement, CircularGalleryProps>(
    ({ items, className, radius = 450, autoRotateSpeed = 0.08, ...props }, ref) => {
        ...
        return (
            <div
                ...
                className={cn("relative w-full h-[850px] flex items-center justify-center", className)}
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    left: '50%',
                                    top: '50%',
                                    marginLeft: `-${GALLERY_ITEM_WIDTH / 2}px`,
                                    marginTop: `-${GALLERY_ITEM_HEIGHT / 2}px`,
                                    opacity: opacity,
